...
- The release workflow creates the immutable `vX.Y.Z` tag and updates the floating major tag such as `v1`.

Consumers should normally pin to a major tag such as `@v1`.
